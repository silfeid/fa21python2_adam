...
directory = r'C:\Users\brode\Python\Laurel Mountain Historical Climate Data\CSV Versions\2000s'
...
def search_function_2000s(query_results):
    ...
    print("The average daily high during ski season for the 2000s was {} degrees Fahrenheit.".format(daily_high_average))
