...
def plotter():
    ...
    sliced_df = pd.read_csv('fa21python2_adam\\workingdataset.csv')
    sliced_df.columns = ['Date', 'Snow Depth', 'Min Temp', 'Max Temp']
    
    var_count = input('\nIf you have not yet specified a date range during this session, the last date range used will be plotted instead. Select variable(s): \n\n 1. Snow Depth\n 2. Minimum Temperature\n 3. Maximum Temperature\n 4. Snow Depth and Minimum Temperature\n 5. Snow Depth and Maximum Temperature\n 6. Minimum and Maximum Temperature\n 7. All\n\n Input (# or Q/q to return to main menu): ')
        
    if var_count in var_choices:
        
        if var_count == '1':
            sliced_df = sliced_df.T
            plt.plot(sliced_df.iloc[:, 0])
            plt.show()
