    ...
    if not country_codes:
        ...
        for country_code in country_codes:
            ...
            if past_data == 'Invalid country code. Three letters are required':
                ...
                past_data_series = past_data_df.at[0, 'data']
                print(past_data_series)
                
                past_data_series.to_csv('fa21python2_adam/API_Project/Data_of_All_Nations/Past_Data/'+country_code+'.csv')
...
def get_future_year_data_a2():
    ...
    if not country_codes:
        ...
        for country_code in country_codes:
            ...
            future_request = 'http://climatedataapi.worldbank.org/climateweb/rest/v1/country/mavg/bccr_bcm2_0/tas/2020/2039/'+country_code+'.json'
            ...
            if future_data == 'Invalid country code. Three letters are required':
                ...
                a2_monthly_series = pd.Series(a2_monthly_values)                

                a2_monthly_series.index = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']                
                a2_monthly_series = a2_monthly_series.T

                a2_monthly_series.to_csv('fa21python2_adam/API_Project/Data_of_All_Nations/Future_Data/a2/'+country_code+'.csv')
...
def build_df_from_past_series():
    ...
    for item in os.listdir(directory):
        ...
        name = item.strip('.csv')
        temp_series = temp_series.drop('month', axis=1)
...
def build_df_from_future_series_a2():
    ...
    directory = r'C:\Users\brode\Python\fa21python2_adam\API_Project\CSV_By_Country\Sample_Data'
    
    for item in os.listdir(directory):
        
        temp_series = pd.read_csv('fa21python2_adam\API_Project\CSV_By_Country\Sample_Data/'+item)
        name = item.strip('.csv')
        ...
        df_of_all_nations = df_of_all_nations.append(temp_series, ignore_index=False)
        
    df_of_all_nations.to_csv('fa21python2_adam/API_Project/Data_of_All_Nations/past_data.csv')
