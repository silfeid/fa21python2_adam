...
def get_df_descriptions():
    ...
    if av_var_choice in valid_av_var_choices:
        ...
        if av_var_choice == '1':
            ...
            plt.bar(snowfall_dict.keys(), snowfall_dict.values(), color = 'skyblue')
        ...
        if av_var_choice == '2':
            ...
            plt.bar(snowdepth_dict.keys(), snowdepth_dict.values(), color = 'thistle')
            plt.xticks(rotation =60, fontsize = 10, ha = 'right')
        ...
        if av_var_choice == '3':
            ...
            plt.bar(tempmin_dict.keys(), tempmin_dict.values(), color = 'cadetblue')
            plt.xticks(rotation =60, fontsize = 10, ha = 'right')
        ...
        if av_var_choice == '4':
            ...
            plt.bar(tempmax_dict.keys(), tempmax_dict.values(), color = 'firebrick')
            plt.xticks(rotation =60, fontsize = 10, ha = 'right')
